      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-xl border-b border-gray-100/80">
          <div className="max-w-7xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between gap-4">
            ...
            {/* Logout */}
            <LogoutButton redirectTo="/login" className="shrink-0 flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors" />
          </div>
        </header>
