          ...
          {selectedRole && (
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm animate-fade-in">
              ...
              <div className="mt-5 pt-4 border-t border-gray-100">
                ...
                {selectedRole === "SUPER_ADMIN" ? (
                  <p className="text-xs text-gray-400 font-mono">superadmin@goco.com · GoCo@123</p>
                ) : (
                  <div className="space-y-0.5">
                    <p className="text-xs text-gray-400 font-mono">admin@urbanthreads.com · Urban@123</p>
                    <p className="text-xs text-gray-400 font-mono">admin@sneakerlab.com · Sneaker@123</p>
                  </div>
                )}
              </div>
            </div>
